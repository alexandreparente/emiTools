...
class emiToolsBatchPhotoExport(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return tr("This algorithm copies image files listed in a field of a vector layer to a destination folder. Works with all features or only the selected ones, depending on the input layer settings.")
