...
class emiToolsExportTerms(QgsProcessingAlgorithm):
    ...
    def export_single_file(self, layer, output_folder, today_str, output_format, feedback):
        ...
        options.driverName = self.get_output_format_string(output_format)
        ...
        if error[0] == QgsVectorFileWriter.NoError:
            ...
            feedback.reportError(tr(f"Error saving file {output_file}: {error[1]}"))
            return []
    ...
    def compress_files(self, output_files, output_format, output_folder, feedback):
        ...
        associated_extensions = format_info['zip_exts']
        ...
        for output_file in output_files:
            ...
            associated_files = [os.path.join(output_folder, f"{base_name}.{ext}") for ext in associated_extensions if
                                os.path.exists(os.path.join(output_folder, f"{base_name}.{ext}"))]
